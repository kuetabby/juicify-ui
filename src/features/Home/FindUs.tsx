      ...
      >
        <div className={`relative why-card-container !mt-2`}>
          <div className="w-full md:w-4/5 lg:w-1/2 flex flex-wrap justify-between items-center relative px-2 mx-auto">
            ...
            <Link
              href="https://dexscreener.com/ethereum/0xaf0E63457b2542B75fcEb6AA066D3DE420A6D88e"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <Link
              href="http://dextools.io/app/ether/pair-explorer/0xf3e1ee54e514b36365adca99f1d475b4072ca49e"
              target="_blank"
              rel="noopener noreferrer"
